...
class Request {
    ...
    private $socials = array('instagram','vimeo','twitch','pinterest','twitter','facebook','youtube','vk','linkedin','ok','google','telegram','reddit');
    ...
    public function start() {
        ...
        $this->loadSettings();
        if ($overrideTheme = $this->input('set-theme')) {
            $this->setConfig('theme', $overrideTheme);
        }
